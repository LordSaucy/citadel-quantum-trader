...
back‑test:
    ...
    2️⃣  Run BacktestValidator on the *train* slice – calibrate hyper‑parameters.

    3️⃣  Run the validator on the *test* slice and record performance metrics.
...
✅ FIXED: Replaced inplace=True with proper variable assignment
"""
...
# =====================================================================
# Dummy strategy – replace with your real one
# =====================================================================
...
# =====================================================================
# Helper – load the full historical dataset once
# =====================================================================
def load_history(csv_path: Path) -> pd.DataFrame:
    ...
    # ✅ FIXED: Don't use inplace=True
    # Before: df.sort_values("time", inplace=True)
    # After:  df = df.sort_values("time")
    df = df.sort_values("time")
    
    # ✅ FIXED: Don't use inplace=True
    # Before: df.reset_index(drop=True, inplace=True)
    # After:  df = df.reset_index(drop=True)
...
# =====================================================================
# CLI entry point – convenient for manual runs
# =====================================================================
def main() -> None:
